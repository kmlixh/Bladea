...
/**
 * Created by kmlixh on 2014/8/27.
 */
...
public class ChinaDate {
    ...
    public final static String[] ChinaMonth = new String[]{"", "正", "二", "三", "四", "五", "六", "七", "八", "九", "十", "冬",
            "腊"};
    ...
    private final static String[] sFtv = new String[]{"0101*元旦", "0214 情人节", "0308 妇女节", "0312 植树节", "0315 消费者权益日",
            "0401 愚人节", "0501 劳动节", "0504 青年节", "0512 护士节", "0601 儿童节", "0701 建党节", "0801 建军节", "0808 父亲节", "0910 教师节", "0928 孔子诞辰", "1001*国庆节", "1006 老人节", "1024 联合国日", "1112 孙中山诞辰", "1220 澳门回归",
            "1225 圣诞节", "1226 毛泽东诞辰"};
     ...
     * @return
     */
    final public static String getAnimalsYear(Calendar cal) {
        long[] yinfo = calElement(cal);
        int y = (int) yinfo[0];
     ...
     * @return
     */
    final public static String getCircleYear(Calendar cal) {
        long[] yinfo = calElement(cal);
        int y = (int) yinfo[0];
        int num = y - 1900 + 36;
    ...
    public static long[] calElement(Calendar cal) {
    ...
    public static String getChinaMonth(Calendar cal) {
        StringBuffer Sb = new StringBuffer();
        long[] l = calElement(cal);
        Sb.append(ChinaMonth[(int) l[1]]);
        Sb.append("月");
        return Sb.toString();
    }

    public static String getChinaDateTotal(Calendar cal) {
        StringBuffer Sb = new StringBuffer();
        Sb.append(getCircleYear(cal) + "(").append(getAnimalsYear(cal) + ")年 ").append(getChinaDateString(cal));
        return Sb.toString();
    }

    public static String getChinaDateString(Calendar cal) {
        StringBuffer Sb = new StringBuffer();
        long[] l = calElement(cal);
        if (l[6] == 1) {
            Sb.append("闰");
        ...
        Sb.append(ChinaMonth[(int) l[1]]);
        Sb.append("月");
        Sb.append(getChinaDay((int) (l[2])));
        return Sb.toString();
    }

    public static int getDateNumber(Calendar cal) {
        long[] l = calElement(cal);
        return (int) l[1] * 1000 + (int) l[2] * 10 + (int) l[6];
    }
